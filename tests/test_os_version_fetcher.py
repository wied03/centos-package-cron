...
class TestOsVersionFetcher(unittest.TestCase):
    def testget_complete_version(self):
        ...
        # assert
        expected = '6.6' if os.environ['CENTOS'] == 'centos6' else '7.0.1406'
    ...
    def testget_top_level_version(self):
        ...
        # assert
        expected = '6' if os.environ['CENTOS'] == 'centos6' else '7'
        self.assertEquals(result, expected)
    ...
    def testget_mid_level_version(self):
        ...
        # assert
        expected = '6.6' if os.environ['CENTOS'] == 'centos6' else '7.0'
        self.assertEquals(result, expected)
